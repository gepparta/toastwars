...
public class DecissionForm extends Panel
{
	...
	public DecissionForm(Button[] buttons, NumberField capital, Object o, ArrayList<Toaster> newToasterList)
	{
	...
	private void createEmptyContent()
	{
		...
		newPanel.addButton(new Button(type.getDescription() + " entwickeln", new ButtonListenerAdapter()
		{
