 ...
 * the License.
 */
package toastwars.client.sliders;
...
public class ResizableWidgetCollection implements WindowResizeListener {
	...
	/**
	 * A static {@link ResizableWidgetCollection} that can be used in most
	 * cases.
	 */
	...
	/**
	 * The timer used to periodically compare the dimensions of elements to
	 * their old dimensions.
	 */
	 ...
	 * Constructor.
	 * 
	 * @param resizeCheckingEnabled
	 *            false to disable resize checking
	 */
