...
public class MarketResearchReport implements Comparator, IsSerializable

{
	...
	public void generateMarketResearchReport(ArrayList<Group> grouplist) {
		...
		for (int i = 0; i < grouplist.size(); i++) {
			...
			for (int a = 0; a < com.getToasterList().size(); a++) {
				...
				radioInvestment += com.getToasterList().get(a)
						.getRadioInvestment();
				tvInvestment += com.getToasterList().get(a).getTvInvestment();
				newspaperInvestment += com.getToasterList().get(a)
						.getNewspaperInvestment();
				qualityInvestment += com.getToasterList().get(a)
						.getQualityInvestment();
				designInvestment += com.getToasterList().get(a)
						.getDesignInvestment();
				ecologyInvestment += com.getToasterList().get(a)
						.getEfficiencyInvestment();

				if (com.getToasterList().get(a).getType() == Type.TYPE1) {
					priceType1RankingInternList.put(com.getToasterList().get(a)
							.getPrice(), "Group" + com.getCompanyID());
					marketshareType1RankingInternList.put(com.getToasterList()
							.get(a).getMarketShare(), "Group"
							+ com.getCompanyID());
				}
				if (com.getToasterList().get(a).getType() == Type.TYPE2) {
					priceType2RankingInternList.put(com.getToasterList().get(a)
							.getPrice(), "Group" + com.getCompanyID());
					marketshareType2RankingInternList.put(com.getToasterList()
							.get(a).getMarketShare(), "Group"
							+ com.getCompanyID());

				}
				if (com.getToasterList().get(a).getType() == Type.TYPE3) {
					priceType3RankingInternList.put(com.getToasterList().get(a)
							.getPrice(), "Group" + com.getCompanyID());
					marketshareType3RankingInternList.put(com.getToasterList()
							.get(a).getMarketShare(), "Group"
							+ com.getCompanyID());

				}
			}
			radioRankingInternList.put(radioInvestment, "Group"
					+ com.getCompanyID());
			tvRankingInternList.put(tvInvestment, "Group" + com.getCompanyID());
			newspaperRankingInternList.put(newspaperInvestment, "Group"
					+ com.getCompanyID());
			designRankingInternList.put(designInvestment, "Group"
					+ com.getCompanyID());
			ecologyRankingInternList.put(ecologyInvestment, "Group"
					+ com.getCompanyID());
			qualityRankingInternList.put(qualityInvestment, "Group"
					+ com.getCompanyID());
		...
		// ArrayList gemacht
		capitalRankingList = new ArrayList(Arrays
				.asList(generateStringArray(capitalRankingInternList)));

		profitRankingList = new ArrayList(Arrays
				.asList(generateStringArray(profitRankingInternList)));
		...
		priceType1RankingList = new ArrayList<String>(Arrays
				.asList(generateStringArray(priceType1RankingInternList)));
		priceType2RankingList = new ArrayList<String>(Arrays
				.asList(generateStringArray(priceType2RankingInternList)));
		priceType3RankingList = new ArrayList<String>(Arrays
				.asList(generateStringArray(priceType3RankingInternList)));

		marketshareType1RankingList = new ArrayList<String>(Arrays
				.asList(generateStringArray(marketshareType1RankingInternList)));
		marketshareType2RankingList = new ArrayList<String>(Arrays
				.asList(generateStringArray(marketshareType2RankingInternList)));
		marketshareType3RankingList = new ArrayList<String>(Arrays
				.asList(generateStringArray(marketshareType3RankingInternList)));
	...
	public List<String> generateHeaders() {
		...
		if (MarketResearchReport.getInstance().getMarketshareType2RankingList()
				.size() != 0)
			liste.add("Marktanteile : Markt 2");
		if (MarketResearchReport.getInstance().getMarketshareType3RankingList()
				.size() != 0)
			liste.add("Marktanteile : Markt 3");
		liste.add("Preisrangliste für Markt 1");
		if (MarketResearchReport.getInstance().getPriceType2RankingList()
				.size() != 0)
			liste.add("Preisrangliste für Markt 2");
		if (MarketResearchReport.getInstance().getPriceType3RankingList()
				.size() != 0)
	...
	public ArrayList<List<String>> getReports() {
		...
		liste.add(MarketResearchReport.getInstance()
				.getMarketshareType1RankingList());
		if (MarketResearchReport.getInstance().getMarketshareType2RankingList()
				.size() != 0)
			liste.add(MarketResearchReport.getInstance()
					.getMarketshareType2RankingList());
		if (MarketResearchReport.getInstance().getMarketshareType3RankingList()
				.size() != 0)
			liste.add(MarketResearchReport.getInstance()
					.getMarketshareType3RankingList());

		liste
				.add(MarketResearchReport.getInstance()
						.getPriceType1RankingList());
		if (MarketResearchReport.getInstance().getPriceType2RankingList()
				.size() != 0)
			liste.add(MarketResearchReport.getInstance()
					.getPriceType2RankingList());
		if (MarketResearchReport.getInstance().getPriceType3RankingList()
				.size() != 0)
			liste.add(MarketResearchReport.getInstance()
					.getPriceType3RankingList());
		return liste;
	}
