...
public class Stock
{
	...
	// maximaler mögliche Menge auf Lager
	// TODO: bei Überschreitung ein boolean false zurückliefern => lagerVoll
	// darauf hin muss die Company den Rest an Toastern wegschmeisen (am
	// leichtesten?)
	...
	public Stock(int stockTT1, int stockTT2, int stockTT3, int maxStockTT1, int maxStockTT2, int maxStockTT3, double stockCostsTT1, double stockCostsTT2, double stockCostsTT3,
			double stockCostsTotal)
	{
