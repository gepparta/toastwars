...
public class Test_Toaster_Type3 extends TestCase
{
	...
	protected void setUp() throws Exception
	{
		...
		toaster1 = new Toaster(150.00, 3.00, 40000.00, 20000.00, 30000.00, 3.00, 15000.00, 15000.00, 15000.00, 9.00, 1000.00, 1000.00, 1000.00, 2500, Type.TYPE3);
	}
	...
	public void testGetQuality()
	{
		...
		assertEquals(15000.0, toaster1.getQualityInvestment());
	}
	...
	public void testGetDesign()
	{
		...
		assertEquals(15000.0, toaster1.getDesignInvestment());
	}
	...
	public void testGetMarketShare()
	{
		...
		assertEquals(2500, toaster1.getMarketShare());
	}
