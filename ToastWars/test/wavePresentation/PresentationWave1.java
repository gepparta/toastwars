...
////////////////////////////////////////////////////////////////////////////////////			
	...
	private void printData()
	{
		...
		for (int i = 0; i < game.getGroupList().size(); i++)
		{
			companyID = game.getGroupList().get(i).getCompany().getCompanyID();
			marketshare = game.getGroupList().get(i).getCompany().getMarketShare();
			marketsharePercent = marketshare / (double)Type.TYPE1.getMarketVolume() * 100;
			turnover = game.getGroupList().get(i).getCompany().getTurnover();
			cost = game.getGroupList().get(i).getCompany().getCost();
			profit = game.getGroupList().get(i).getCompany().getProfit();
			capital = game.getGroupList().get(i).getCompany().getCapital();
